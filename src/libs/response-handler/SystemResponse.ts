...
class SystemResponse {
  ...
  public static paymentRequiredError(message, error) {
    return SystemResponse.getInstance()
      .getErrorResponse(message, error, StatusCodes.PAYMENT_REQUIRED);
  }
  ...
  public static lengthRequiredError(message, error) {
    return SystemResponse.getInstance()
      .getErrorResponse(message, error, StatusCodes.LENGTH_REQUIRED);
  }
  ...
  public static preconditionFailedError(message, error) {
    return SystemResponse.getInstance()
      .getErrorResponse(message, error, StatusCodes.PRECONDITION_FAILED);
  }
  ...
  public static requestEntityTooLargeError(message, error) {
    return SystemResponse.getInstance()
      .getErrorResponse(message, error, StatusCodes.REQUEST_ENTITY_TOO_LARGE);
  }
  ...
  public static unsupportedMediaTypeError(message, error) {
    return SystemResponse.getInstance()
      .getErrorResponse(message, error, StatusCodes.UNSUPPORTED_MEDIA_TYPE);
  }
  ...
  public static rangeNotSatisfiableError(message, error) {
    return SystemResponse.getInstance()
      .getErrorResponse(message, error, StatusCodes.REQUESTED_RANGE_NOT_SATISFIABLE);
  }
  ...
  public static expectationFailedError(message, error) {
    return SystemResponse.getInstance()
      .getErrorResponse(message, error, StatusCodes.EXPECTATION_FAILED);
  }
  ...
  public static httpVersionNotSupportedError(message, error) {
    return SystemResponse.getInstance()
      .getErrorResponse(message, error, StatusCodes.HTTP_VERSION_NOT_SUPPORTED);
  }

  /**
   * This method gets message, error, and code as parameters
   * and returns the formatted object for the error response.
